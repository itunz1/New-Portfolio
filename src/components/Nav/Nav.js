            ...
            <div className='px-4 mx-auto max-w-7xl sm:px-6'>
                <div className='flex items-center justify-between px-10 py-6 md:space-x-10'>
                    ...
                    <Link to="home"
                            ...
                            offset={-70}
                            duration={800}>
                        <span className='text-[#fff59d] shadow-[rgb(255 245 157)_0px_0px_10px] font-bold text-2xl cursor-pointer'>JL</span>
                        </Link>
                ...
                <Popover.Panel focus className='absolute inset-x-0 top-0 p-2 transition origin-top-right transform md:hidden'>
                    <div className='bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50'>
                        ...
                        <div className='px-5 py-6 space-y-6'>
                            ...
                            offset={-70}
                            duration={800}>
                            <span className='inline-flex items-center gap-1 text-lg font-medium text-black cursor-pointer hover:text-blue-400'>< FaRegUser className='text-sm' />About</span>
                        </Link>
                        ...
                        <Link to="skills"
                            ...
                            offset={-70}
                            duration={800}>
                        <span className='inline-flex items-center gap-1 text-lg font-medium text-black cursor-pointer hover:text-blue-400'><FaCode className='text-base' />Skills</span>
                        </Link>
                        ...
                        <Link to="proyects"
                            ...
                            offset={-20}
                            duration={800}>
                        <span className='inline-flex items-center gap-1 text-lg font-medium text-black cursor-pointer hover:text-blue-400'><FaChalkboard className='text-base' />Proyects</span>
                        </Link>
                        ...
                        <Link to="contact"
                            ...
                            offset={-20}
                            duration={800}>
                        <span className='inline-flex items-center gap-1 text-lg font-medium text-black cursor-pointer hover:text-blue-400'> <FaAddressBook className='text-sm' />Contact</span>
                        </Link>
                            </div>
