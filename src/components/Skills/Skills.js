...
export default function Skills() {
    return (
        <div>
            <h2 className='text-white text-6xl mb-10'>Skills</h2>
            <div className='grid grid-cols-2'>
                <h3 className='text-white text-2xl text-center w-10/12'>Special Skills</h3>
                <h3 className='text-white text-2xl text-center mb-8'>Tech Skills</h3>
            </div>

            <div className='flex justify-between'>
                <div className='w-5/12 '>
                    <div className='px-11 pb-12 pt-11 mb-6 bg-[#2a2c39] shadow-xl shadow-current-500/40 '>
                        <div className="mb-6 text-base font-medium text-[#858792]">Comunication</div>
                        <div className="w-full bg-gray-200 rounded-full dark:bg-gray-700 h-2">
                            <div className="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full h-2" style={{ width: "75%" }}> 75%</div>
                        </div>
                    </div>

                    <div className='px-11 pb-12 pt-11 mb-6 bg-[#2a2c39] shadow-xl shadow-current-500/40'>
                        <div className="mb-6 text-base font-medium text-[#858792]">Leadership</div>
                        <div className="w-full bg-gray-200 rounded-full dark:bg-gray-700 h-2">
                            <div className="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full h-2" style={{ width: "70%" }}> 70%</div>
                        </div>
                    </div>

                    <div className='px-11 pb-12 pt-11 mb-6 bg-[#2a2c39] shadow-xl shadow-current-500/40'>
                        <div className="mb-6 text-base font-medium text-[#858792]">Teamwork</div>
                        <div className="w-full bg-gray-200 rounded-full dark:bg-gray-700 h-2">
                            <div className="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full h-2" style={{ width: "90%" }}> 90%</div>
                        </div>
                    </div>

                    <div className='px-11 pb-12 pt-11 bg-[#2a2c39] shadow-xl shadow-current-500/40'>
                        <div className="mb-6 text-base font-medium text-[#858792]">Flexibility</div>
                        <div className="w-full bg-gray-200 rounded-full dark:bg-gray-700 h-2">
                            <div className="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full h-2" style={{ width: "80%" }}> 80%</div>
                        </div>
                    </div>
                </div>
                <div className='flex flex-col justify-center w-6/12 bg-[#2a2c39]'>
                    <div>
                        <div className='flex justify-center items-center gap-x-24 mb-14'>
                    ...
                    <div>
                        <div className='flex justify-center items-center gap-x-24 ml-5'>
