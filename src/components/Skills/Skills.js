...
export default function Skills() {
    return (
        <div>
            ...
            <div className="w-full absolute h-[1px] bg-[rgba(255,255,255,.5)] top-[10%] ml-7 sm:top-[9%] md:top-[11%] lg:top-[12%]"></div>
            ...
            <div className='flex flex-col mx-5 md:justify-between md:flex md:flex-row gap-x-9 lg:mx-auto lg:gap-x-auto lg:px-10 lg:gap-auto'>
                ...
                <div className='h-fit mt-8 md:mt-0 p-8 grid grid-cols-3 gap-y-2 items-center sm:w-11/12 sm:p-12 sm:gap-y-8 md:p-10 md:h-[41rem] md:w-6/12 lg:px-10 lg:py-2 bg-[#2a2c39]'>
