...
export default class Proyects extends Component {
    render() {
        const settings = {
            className: "p-10 border-1 border-white mx-auto",
            dots: true,
            infinite: true,
            speed: 500,
            slidesToShow: 1,
            ...
            <div className="mx-auto w-12/12">
                ...
                <Slider {...settings}>
                    <div className="flex items-center justify-center">
                        ...
                        <p className="text-[#858792] text-center bg-[#262626] border-x-4 mx-auto border-b-4 pb-8">HTML-CSS / Food Website / Course /Template</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center ">
                        ...
                        <p className="text-[#858792] text-center bg-[#262626] border-x-4 border-b-4 pb-8">React-Redux-CSS-PostgresSQL / App / Personal / Template</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <p className="text-[#858792] text-center bg-[#262626] border-x-4 border-b-4 pb-8">React-Redux-CSS-PostgresSQL / App / Bootcamp</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <p className="text-[#858792] text-center bg-[#262626] border-x-4 border-b-4 pb-8">React-Redux-CSS-PostgresSQL-MercadoPago-Auth0 / Ecommerce / Bootcamp</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <p className="text-[#858792] text-center bg-[#262626] border-x-4 border-b-4 pb-8">React / Utility / Components</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <p className="text-[#858792] text-center bg-[#262626] border-x-4 border-b-4 pb-8">React-NextJs / Post-Comment / Component</p>
                    </div>
                    ...
                    <div className="flex items-center justify-center">
                        ...
                        <p className="text-[#858792] text-center bg-[#262626] border-x-4 border-b-4 pb-8">HTML-CSS / Glass Website / Design Template</p>
                    </div>
                </Slider>
            </div>
        );
